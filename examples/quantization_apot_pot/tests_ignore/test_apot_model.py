"""Test script for APoT quantized model."""
...
def test_apot_model(model_path: str):
    """Test the APoT quantized model with various prompts."""
    
    print(f"Loading APoT quantized model from: {model_path}")
...
def main():
    # Default model path (created by llama_apot_example.py)
